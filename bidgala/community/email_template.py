...
def receiveComment(title, link_to_post, comment, commented_by_name):
          ...
          <div style="max-width:600px;margin:0 auto" class="email-container">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:auto">
              ...
              <tr>
                ...
                <p style="line-height: 25px;color: #222;">New comment on """+ title +""" <a href='"""+link_to_post+"""'><em>(view post)</em></a></p>
               ...
               """+ comment + """
                ...
                <p style="margin-bottom: 40px; color: #222; ">-""" +commented_by_name+ """</p>
                </td>
            </tr>
              <tr>
