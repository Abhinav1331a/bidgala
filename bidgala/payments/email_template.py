...
def acceptRequest(artist_name, buyer_name, product):
        ...
        <table cellpadding="0" cellspacing="0" width="600px">
          ...
          <tr>
            <td colspan="2" style="width:100%; color:#111;">
              <h4>Congratulations """ + artist_name + """! You have receievd a new purchase request from """ + buyer_name + """. Please check your orders page to accept/decline the request.</h4>
              <p><u>Order details:</u><br>Product:"""+product.art_title+"""<br>Price: """+str(product.price)+""" </p>
            </td>
          </tr>
          <tr>
            <td colspan="2" style="font-size: 0; line-height: 0; width:100%;" height="40px">&nbsp;</td>
