...
def receiveComment(title, link_to_art, comment, commented_by_name):
        ...
        <table cellpadding="0" cellspacing="0" width="600px">
          ...
          <tr>
            <td colspan="2" style="width:100%; color:#111;">
              <p style="line-height: 25px; color:#111;">New comment on """+ title +""" <a href='"""+link_to_art+"""'><em>(view art)</em></a></p>
              <p>
                """+ comment + """
              </p>
              <p>-""" +commented_by_name+ """</p>
            </td>
          </tr>
          <tr>
            <td colspan="2" style="font-size: 0; line-height: 0; width:100%;" height="40px">&nbsp;</td>
