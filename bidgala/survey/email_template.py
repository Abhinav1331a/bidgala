...
def surveyCompleteTemplate(name):
  email_template = """
        ...
        <table cellpadding="0" cellspacing="0" width="600px">
          <tr>
            <td colspan="2" style="width:100%; color:#111;">
              <p>Hello """ + name + """,</p>
              <p>Thank you for requesting guidance from a curator tofind artworks handpicked for you to purchase. We will get back to you soon.
              </p>
              <p>If there's anything you need assistance with, please don't hesitate to contact us at <a href="mailto:info@bidgala.com">info@bidgala.com.</a>
              </p>
            </td>
          </tr>
